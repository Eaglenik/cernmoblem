...
gsap.fromTo('.nav', {top: 0}, {
    top: -200,
    scrollTrigger: {
        trigger: '.development__descr_margin-bottom',
        scrub: true
    }
})
gsap.fromTo('.nav-main', {top: 0}, {
    top: -200,
    scrollTrigger: {
        trigger: '.development__descr_margin-bottom',
        scrub: true
...
gsap.fromTo('.main-back', {opacity: 0}, {
    opacity: 1,
    scrollTrigger: {
        trigger: '.product',
        scrub: true,
...
gsap.fromTo('.main-back', {opacity: 1}, {
    opacity: 0,
    scrollTrigger: {
        trigger: '.despre',
        scrub: true,
